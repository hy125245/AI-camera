...
public:
    static EmbeddingOutput embeddingP(const std::string& input, const std::string& uid = {});
    static EmbeddingOutput embeddingQ(const std::string& input, const std::string& uid = {});
};
